 ...
 */
    ...
    (() => {
        ...
        if (inputMasks.length) {
            modules_flsModules.inputmask = Inputmask("+38 999 999 99 99").mask(inputMasks);
            modules_flsModules.inputmask = Inputmask("9999 9999 9999 9999").mask(inputCard);
            modules_flsModules.inputmask = Inputmask("99/99").mask(inputDate);
        }
        ...
        function initSliders() {
            if (document.querySelector(".swiper-main-slider")) new core(".swiper-main-slider", {
            ...
            document.querySelectorAll(".slider-block").forEach((n => {
                if (n.querySelector(".slider-block__slider")) {
                    new core(n.querySelector(".slider-block__slider"), {
            ...
            if (document.querySelector(".image-big-swiper")) new core(".image-big-swiper", {
                ...
                thumbs: {
                    swiper: {
                        el: ".image-mini-swiper",
                        slidesPerView: 5,
                        direction: "vertical",
                        navigation: {
                            prevEl: ".image-mini-swiper__button-prev",
                            nextEl: ".image-mini-swiper__button-next"
                        }
                    }
                },
                on: {}
        ...
        da.init();
        let likeButtons = document.querySelectorAll(".slide-slider-block__like");
        document.addEventListener("click", (e => {
            for (let elem of likeButtons) if (e.target == elem) elem.classList.toggle("_active");
        }));
        let selectForm = document.querySelector(".select_form");
        if (selectForm) selectForm.addEventListener("click", (() => {
            if ("По цене" == document.querySelector(".select__content").innerHTML) mySort("data-price");
            if ("По рейтингу" == document.querySelector(".select__content").innerHTML) mySort("data-rating");
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
